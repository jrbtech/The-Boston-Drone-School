      ...
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-12 px-6 py-12 lg:flex-row lg:items-start lg:justify-between">
        <div className="max-w-md space-y-4">
          <div className="flex items-center gap-3">
            <span className="flex h-11 w-11 items-center justify-center border border-white text-sm font-semibold uppercase tracking-[0.4em]">
              BDS
            </span>
            <div className="flex flex-col">
              ...
              <span className="text-[0.62rem] uppercase tracking-[0.37em] text-white/50">
                Operations · Training · Advocacy
              </span>
            </div>
          </div>
          <p className="text-sm leading-relaxed text-white/70">
            Professional drone services, policy consultation, and mission-ready training programs. We connect modern
            UAS operations to enterprise, educational, and civic partners across New England and beyond.
          </p>
