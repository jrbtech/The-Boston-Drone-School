      ...
      <div className="container-premium section-spacing">
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          <div className="space-y-6 text-center">
            <span className="inline-block bg-green-100 text-green-800 px-4 py-2 rounded-full text-sm font-semibold uppercase tracking-wider">
              100% Free
            </span>
          ...
          {/* Main Download Card */}
          {!downloaded ? (
            <div className="course-card p-10 bg-gradient-to-br from-blue-50 to-white border-2 border-blue-200">
            ...
            <div className="course-card p-10 bg-green-50 border-2 border-green-200 text-center">
          ...
          {/* CTA for Full Course */}
          <div className="course-card p-10 bg-black text-white text-center">
